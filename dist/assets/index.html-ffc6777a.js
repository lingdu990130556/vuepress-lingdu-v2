import{_ as n,o as e,c as i,f as a}from"./app-32a2b7dc.js";const s={},l=a(`<h1 id="canal" tabindex="-1"><a class="header-anchor" href="#canal" aria-hidden="true">#</a> Canal</h1><h2 id="canal→kafka" tabindex="-1"><a class="header-anchor" href="#canal→kafka" aria-hidden="true">#</a> canal→kafka</h2><p>配置参考：<br><code>canal.properties</code></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>#################################################
######### 		common argument		#############
#################################################
# tcp bind ip
