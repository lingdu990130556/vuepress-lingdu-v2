...
<head>
    ...
    <link rel="stylesheet" href="./style.css?v1.7.7">
</head>
<body>
<!--[if lte IE 9]>
...
<footer class="footer">
    <p class="am-text-sm">v1.7.7&nbsp;&copy;&nbsp;2023&nbsp;<a href="javascript:void(0)" data-am-modal="{target: '#copr-info'}">免责声明</a></p>
</footer>
...
<script src="./music.js?v1.7.7"></script>
</body>
</html>
