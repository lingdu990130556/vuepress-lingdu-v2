...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.2.0/node_modules/mermaid/dist/gitGraphDiagram-55446347.js
var me = function() {
  var r = function(B, l, u, b2) {
    for (u = u || {}, b2 = B.length; b2--; u[B[b2]] = l)
      ;
    return u;
    ...
    performAction: function(l, u, b2, i, E, e, W) {
      var t = e.length - 1;
      switch (E) {
        case 3:
          return e[t];
    ...
    parse: function(l) {
      var u = this, b2 = [0], i = [], E = [null], e = [], W = this.table, t = "", Z = 0, be = 0, Re = 2, ge = 1, Ce = e.slice.call(arguments, 1), L = Object.create(this.lexer), q = { yy: {} };
      ...
      for (var S, Y, D, le, U = {}, $, z, de, ee2; ; ) {
        if (Y = b2[b2.length - 1], this.defaultActions[Y] ? D = this.defaultActions[Y] : ((S === null || typeof S > "u") && (S = Me()), D = W[Y] && W[Y][S]), typeof D > "u" || !D.length || !D[0]) {
          var he = "";
          ee2 = [];
          for ($ in W[Y])
            this.terminals_[$] && $ > Re && ee2.push("'" + this.terminals_[$] + "'");
          L.showPosition ? he = "Parse error on line " + (Z + 1) + `:
` + L.showPosition() + `
Expecting ` + ee2.join(", ") + ", got '" + (this.terminals_[S] || S) + "'" : he = "Parse error on line " + (Z + 1) + ": Unexpected " + (S == ge ? "end of input" : "'" + (this.terminals_[S] || S) + "'"), this.parseError(he, {
            text: L.match,
        ...
        switch (D[0]) {
          case 1:
            b2.push(S), E.push(L.yytext), e.push(L.yylloc), b2.push(D[1]), S = null, be = L.yyleng, t = L.yytext, Z = L.yylineno, oe = L.yylloc;
            break;
          case 2:
            if (z = this.productions_[D[1]][1], U.$ = E[E.length - z], U._$ = {
              ...
              return le;
            z && (b2 = b2.slice(0, -1 * z * 2), E = E.slice(0, -1 * z), e = e.slice(0, -1 * z)), b2.push(this.productions_[D[1]][0]), E.push(U.$), e.push(U._$), de = W[b2[b2.length - 2]][b2[b2.length - 1]], b2.push(de);
            break;
          case 3:
            return true;
        }
    ...
    var B = {
      EOF: 1,
      parseError: function(u, b2) {
        if (this.yy.parser)
          this.yy.parser.parseError(u, b2);
        else
          throw new Error(u);
      },
      ...
      unput: function(l) {
        ...
        return this.yylloc = {
          ...
          last_column: b2 ? (b2.length === i.length ? this.yylloc.first_column : 0) + i[i.length - b2.length].length - b2[0].length : this.yylloc.first_column - u
...
` + u + "^";
      ...
      next: function() {
        ...
        for (var E = this._currentRules(), e = 0; e < E.length; e++)
          if (b2 = this._input.match(this.rules[E[e]]), b2 && (!u || b2[0].length > u[0].length)) {
            if (u = b2, i = e, this.options.backtrack_lexer) {
              if (l = this.test_match(b2, E[e]), l !== false)
                return l;
              if (this._backtrack) {
                u = false;
                continue;
...
` + this.showPosition(), {
      ...
      performAction: function(u, b2, i, E) {
        switch (i) {
          case 0:
...
me.parser = me;
var Be = me;
var te = Et().gitGraph.mainBranchName;
var qe = Et().gitGraph.mainBranchOrder;
var R = {};
var O = null;
var Q = {};
...
var Je = function(r, n, o, h) {
  b.debug("Entering commit:", r, n, o, h), n = zn.sanitizeText(n, Et()), r = zn.sanitizeText(r, Et()), h = zn.sanitizeText(h, Et());
  const a = {
    id: n || K + "-" + fe(),
    message: r,
    seq: K++,
  ...
  O = a, R[a.id] = a, T[M] = a.id, b.debug("in pushCommit " + a.id);
};
var Qe = function(r, n) {
  if (r = zn.sanitizeText(r, Et()), T[r] === void 0)
    T[r] = O != null ? O.id : null, Q[r] = { name: r, order: n ? parseInt(n, 10) : null }, Ee(r), b.debug("in createBranch");
  else {
    let o = new Error(
...
var Xe = function(r, n, o, h) {
  r = zn.sanitizeText(r, Et()), n = zn.sanitizeText(n, Et());
  ...
  O = f, R[f.id] = f, T[M] = f.id, b.debug(T), b.debug("in mergeBranch");
};
var Ze = function(r, n, o) {
  if (b.debug("Entering cherryPick:", r, n, o), r = zn.sanitizeText(r, Et()), n = zn.sanitizeText(n, Et()), o = zn.sanitizeText(o, Et()), !r || R[r] === void 0) {
    let c = new Error(
  ...
  if (!n || R[n] === void 0) {
    ...
    O = f, R[f.id] = f, T[M] = f.id, b.debug(T), b.debug("in cherryPick");
  }
};
var Ee = function(r) {
  if (r = zn.sanitizeText(r, Et()), T[r] === void 0) {
...
var et = function() {
  R = {}, O = null;
  let r = Et().gitGraph.mainBranchName, n = Et().gitGraph.mainBranchOrder;
  T = {}, T[r] = null, Q = {}, Q[r] = { name: r, order: n }, M = r, K = 0, Qa();
};
var tt = function() {
...
var _e = (r, n, o) => {
  const h = al().gitGraph, a = r.append("g").attr("class", "commit-bullets"), c = r.append("g").attr("class", "commit-labels");
  let f = 0;
...
var pt = (r, n) => {
  const o = al().gitGraph, h = r.append("g");
  n.forEach((a, c) => {
...
`, "id:", n, o), J = h.db.getCommits();
  ...
  const w = Ct(`[id="${n}"]`);
  _e(w, J, false), c.showBranches && pt(w, f), ut(w, J), _e(w, J, true), Di.insertTitle(
    w,
    "gitTitleText",
    c.titleTopMargin,
...
//# sourceMappingURL=gitGraphDiagram-55446347-B2UVQ3LI.js.map
