...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.2.0/node_modules/mermaid/dist/journeyDiagram-e9f7e166.js
var Z = function() {
...
var Pt = function(t, e, s) {
  ee.parseDirective(this, t, e, s);
};
var At = function() {
  J.length = 0, N.length = 0, L = "", B.length = 0, Qa();
};
var It = function(t) {
  L = t, J.push(t);
};
...
`);
  ...
  let c2;
  o === "sandbox" && (c2 = Ct("#i" + e));
  const y = o === "sandbox" ? Ct(c2.nodes()[0].contentDocument.body) : Ct("body");
  M.init();
  const u = y.select("#" + e);
  j.initGraphics(u);
  ...
  wm(u, b, _, i.useMaxWidth), u.append("line").attr("x1", C).attr("y1", i.height * 4).attr("x2", _ - C - 4).attr("y2", i.height * 4).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)");
  const r = g ? 70 : 0;
...
//# sourceMappingURL=journeyDiagram-e9f7e166-2M4HVZYY.js.map
