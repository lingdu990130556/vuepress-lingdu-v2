...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.2.0/node_modules/mermaid/dist/styles-4ffad38c.js
var mt = function() {
  var t = function(D, r, a, i) {
    ...
    parse: function(r) {
      ...
      for (var _, L, m, gt, N = {}, rt, b2, Lt, nt; ; ) {
...
Expecting ` + nt.join(", ") + ", got '" + (this.terminals_[_] || _) + "'" : _t = "Parse error on line " + (C + 1) + ": Unexpected " + (_ == $ ? "end of input" : "'" + (this.terminals_[_] || _) + "'"), this.parseError(_t, {
        ...
        switch (m[0]) {
          case 1:
            ...
            break;
          case 2:
            if (b2 = this.productions_[m[1]][1], N.$ = y[y.length - b2], N._$ = {
              first_line: e[e.length - (b2 || 1)].first_line,
              last_line: e[e.length - 1].last_line,
              first_column: e[e.length - (b2 || 1)].first_column,
              last_column: e[e.length - 1].last_column
            }, zt && (N._$.range = [
              e[e.length - (b2 || 1)].range[0],
              ...
              return gt;
            b2 && (i = i.slice(0, -1 * b2 * 2), y = y.slice(0, -1 * b2), e = e.slice(0, -1 * b2)), i.push(this.productions_[m[1]][0]), y.push(N.$), e.push(N._$), Lt = B[i[i.length - 2]][i[i.length - 1]], i.push(Lt);
            break;
          case 3:
            return true;
        }
...
var oe = function(t, s, n) {
  ee.parseDirective(this, t, s, n);
};
var he = (t) => {
  b.info("Setting root doc", t), lt = t;
};
var ue = () => lt;
var ct = (t, s, n) => {
  if (s.stmt === Rt)
...
var fe = (t) => {
  let s;
  t.doc ? s = t.doc : s = t, b.info(s), Yt(true), b.info("Extract", s), s.forEach((n) => {
    switch (n.stmt) {
      case Tt:
        I(
          n.id.trim(),
...
var I = function(t, s = xt, n = null, h = null, u = null, f = null, p = null, v = null) {
  ...
  g.states[d] === void 0 ? (b.info("Adding state ", d, h), g.states[d] = {
    id: d,
    descriptions: [],
    type: s,
    doc: n,
    ...
    styles: [],
    textStyles: []
  }) : (g.states[d].doc || (g.states[d].doc = n), g.states[d].type || (g.states[d].type = s)), h && (b.info("Setting state description", d, h), typeof h == "string" && Et2(d, h.trim()), typeof h == "object" && h.forEach((k) => Et2(d, k.trim()))), u && (g.states[d].note = u, g.states[d].note.text = zn.sanitizeText(
    g.states[d].note.text,
    Et()
  )), f && (b.info("Setting state classes", d, f), (typeof f == "string" ? [f] : f).forEach((T) => Dt(d, T.trim()))), p && (b.info("Setting state styles", d, p), (typeof p == "string" ? [p] : p).forEach((T) => Ee(d, T.trim()))), v && (b.info("Setting state styles", d, p), (typeof v == "string" ? [v] : v).forEach((T) => xe(d, T.trim())));
};
var Yt = function(t) {
  ot = {
    root: Ft()
  }, g = ot.root, V = 0, P = Pt(), t || Qa();
};
var F = function(t) {
  return g.states[t];
};
...
function me(t, s, n) {
  ...
  I(
    ...
    id1: h,
    id2: f,
    relationTitle: zn.sanitizeText(n, Et())
  });
}
var Gt = function(t, s, n) {
  if (typeof t == "object")
    ...
    I(h, u), I(f, p), g.relations.push({
      id1: h,
      id2: f,
      title: zn.sanitizeText(n, Et())
    });
  }
};
var Et2 = function(t, s) {
  const n = g.states[t], h = s.startsWith(":") ? s.replace(":", "").trim() : s;
  n.descriptions.push(zn.sanitizeText(h, Et()));
};
var Te = function(t) {
...
//# sourceMappingURL=chunk-6LDCXTBL.js.map
