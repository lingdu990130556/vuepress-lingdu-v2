...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.2.0/node_modules/mermaid/dist/requirementDiagram-128084d2.js
var he = function() {
  var e = function(q, r, s, l) {
    for (s = s || {}, l = q.length; l--; s[q[l]] = r)
      ;
    return s;
  }, t = [1, 3], a = [1, 5], c = [1, 6], d = [1, 7], u = [1, 8], p = [5, 6, 8, 14, 16, 18, 19, 40, 41, 42, 43, 44, 45, 53, 71, 72], h = [1, 22], o = [2, 13], g = [1, 26], R = [1, 27], x = [1, 28], S2 = [1, 29], T = [1, 30], v = [1, 31], A2 = [1, 24], N = [1, 32], w = [1, 33], pe = [1, 36], F = [71, 72], fe = [5, 8, 14, 16, 18, 19, 40, 41, 42, 43, 44, 45, 53, 60, 62, 71, 72], _e = [1, 56], ye = [1, 57], ge = [1, 58], Ee = [1, 59], Re = [1, 60], me = [1, 61], Ie = [1, 62], O = [62, 63], M = [1, 74], P = [1, 70], Y = [1, 71], U = [1, 72], B = [1, 73], Q = [1, 75], j = [1, 79], X = [1, 80], J = [1, 77], Z = [1, 78], m = [5, 8, 14, 16, 18, 19, 40, 41, 42, 43, 44, 45, 53, 71, 72], re = {
    trace: function() {
    },
    yy: {},
    ...
    parse: function(r) {
      var s = this, l = [0], i = [], _ = [null], n = [], K = this.table, f = "", ee2 = 0, be = 0, Le = 2, ke = 1, Oe = n.slice.call(arguments, 1), E = Object.create(this.lexer), C = { yy: {} };
      ...
      for (var I, D, k, le, H = {}, te, V, Se, ie; ; ) {
        if (D = l[l.length - 1], this.defaultActions[D] ? k = this.defaultActions[D] : ((I === null || typeof I > "u") && (I = De()), k = K[D] && K[D][I]), typeof k > "u" || !k.length || !k[0]) {
          ...
          E.showPosition ? ce = "Parse error on line " + (ee2 + 1) + `:
` + E.showPosition() + `
Expecting ` + ie.join(", ") + ", got '" + (this.terminals_[I] || I) + "'" : ce = "Parse error on line " + (ee2 + 1) + ": Unexpected " + (I == ke ? "end of input" : "'" + (this.terminals_[I] || I) + "'"), this.parseError(ce, {
            text: E.match,
        ...
        switch (k[0]) {
          case 1:
            l.push(I), _.push(E.yytext), n.push(E.yylloc), l.push(k[1]), I = null, be = E.yyleng, f = E.yytext, ee2 = E.yylineno, ae = E.yylloc;
            break;
          case 2:
...
var st = (e) => {
  b2 !== void 0 && (b2.verifyMethod = e);
};
var at = (e) => (z[e] === void 0 && (z[e] = {
  name: e,
  type: L.type,
  docRef: L.docRef
}, b.info("Added new requirement: ", e)), L = {}, z[e]);
var lt = () => z;
var ct = (e) => {
  L !== void 0 && (L.type = e);
};
...
var Et2 = function(e, t, a, c, d) {
  ...
  t.type == d.db.Relationships.CONTAINS ? h.attr(
    "marker-start",
    "url(" + zn.getUrl(y.arrowMarkerAbsolute) + "#" + t.type + "_line_ending)"
  ) : (h.attr("stroke-dasharray", "10,7"), h.attr(
    "marker-end",
    "url(" + zn.getUrl(y.arrowMarkerAbsolute) + "#" + Ae.ReqMarkers.ARROW + "_line_ending)"
  )), gt(e, h, y, `<<${t.type}>>`);
};
var Rt = (e, t, a) => {
  Object.keys(e).forEach((c) => {
    let d = e[c];
    c = W(c), b.info("Added new requirement: ", c);
...
var kt = (e, t, a, c) => {
  y = Et().requirement, c.db.clear(), c.parser.parse(e);
  ...
  const S2 = y.rect_padding, T = h.node().getBBox(), v = T.width + S2 * 2, A2 = T.height + S2 * 2;
  wm(h, A2, v, y.useMaxWidth), h.attr("viewBox", `${T.x - S2} ${T.y - S2} ${v} ${A2}`);
};
var St = {
  draw: kt
};
...
//# sourceMappingURL=requirementDiagram-128084d2-3B6BSH2U.js.map
