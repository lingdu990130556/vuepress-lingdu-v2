...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.2.0/node_modules/mermaid/dist/erDiagram-6e9c0e5f.js
var ct = function() {
  var t = function(M, a, l, d) {
    ...
    parse: function(a) {
      var l = this, d = [0], u = [], m = [null], i = [], Q = this.table, h = "", J = 0, ht = 0, Et2 = 2, dt = 1, mt = i.slice.call(arguments, 1), b2 = Object.create(this.lexer), H = { yy: {} };
      for (var rt in this.yy)
        Object.prototype.hasOwnProperty.call(this.yy, rt) && (H.yy[rt] = this.yy[rt]);
      b2.setInput(a, H.yy), H.yy.lexer = b2, H.yy.parser = this, typeof b2.yylloc > "u" && (b2.yylloc = {});
      var it = b2.yylloc;
      i.push(it);
      var gt = b2.options && b2.options.ranges;
      typeof H.yy.parseError == "function" ? this.parseError = H.yy.parseError : this.parseError = Object.getPrototypeOf(this).parseError;
      function kt() {
        var W;
        return W = u.pop() || b2.lex() || dt, typeof W != "number" && (W instanceof Array && (u = W, W = u.pop()), W = l.symbols_[W] || W), W;
      }
      for (var D, G, L, at, K = {}, $, F, ut, tt; ; ) {
        if (G = d[d.length - 1], this.defaultActions[G] ? L = this.defaultActions[G] : ((D === null || typeof D > "u") && (D = kt()), L = Q[G] && Q[G][D]), typeof L > "u" || !L.length || !L[0]) {
          ...
          tt = [];
          for ($ in Q[G])
            this.terminals_[$] && $ > Et2 && tt.push("'" + this.terminals_[$] + "'");
          b2.showPosition ? nt = "Parse error on line " + (J + 1) + `:
` + b2.showPosition() + `
Expecting ` + tt.join(", ") + ", got '" + (this.terminals_[D] || D) + "'" : nt = "Parse error on line " + (J + 1) + ": Unexpected " + (D == dt ? "end of input" : "'" + (this.terminals_[D] || D) + "'"), this.parseError(nt, {
        ...
        switch (L[0]) {
          case 1:
            d.push(D), m.push(b2.yytext), i.push(b2.yylloc), d.push(L[1]), D = null, ht = b2.yyleng, h = b2.yytext, J = b2.yylineno, it = b2.yylloc;
            break;
          case 2:
...
` + this.showPosition(), {
  ...
  return S2.prototype = w, w.Parser = S2, new S2();
}();
ct.parser = ct;
var Ct2 = ct;
var j = {};
...
var Zt = function(t, r, e) {
  ee.parseDirective(this, t, r, e);
};
var pt = function(t) {
  return j[t] === void 0 && (j[t] = { attributes: [] }, b.info("Added new entity :", t)), j[t];
};
var Ft = () => j;
var Wt = function(t, r) {
  let e = pt(t), n;
  for (n = r.length - 1; n >= 0; n--)
    e.attributes.push(r[n]), b.debug("Added attribute ", r[n].attributeName);
};
var Vt = function(t, r, e, n) {
  ...
  lt.push(s), b.debug("Added new relationship :", s);
};
var Ut = () => lt;
var zt = function() {
  j = {}, lt = [], Qa();
...
function re(t) {
  ...
  for (let f = 0; f < s; ++f) {
    ...
    for (let y = 0; y < 80; ++y) {
      const A2 = Math.floor(y / 20), Y = ot(c, 5) + ee2(A2, _, E, g) + O + r[A2] + o[y] >>> 0;
...
var oe = (t, r, e) => {
  ...
  e.forEach((N) => {
    ...
    let k = 0;
    const x = jd(N.attributeType), P = t.append("text").classed("er entityLabel", true).attr("id", `${v}-type`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", Et().fontFamily).style("font-size", p + "px").text(x), Z = t.append("text").classed("er entityLabel", true).attr("id", `${v}-name`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", Et().fontFamily).style("font-size", p + "px").text(N.attributeName), w = {};
    w.tn = P, w.nn = Z;
    const z = P.node().getBBox(), S2 = Z.node().getBBox();
    if (E = Math.max(E, z.width), g = Math.max(g, S2.width), k = Math.max(z.height, S2.height), c) {
      const M = N.attributeKeyTypeList !== void 0 ? N.attributeKeyTypeList.join(",") : "", a = t.append("text").classed("er entityLabel", true).attr("id", `${v}-key`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", Et().fontFamily).style("font-size", p + "px").text(M);
      w.kn = a;
      const l = a.node().getBBox();
      O = Math.max(O, l.width), k = Math.max(k, l.height);
    }
    if (_) {
      const M = t.append("text").classed("er entityLabel", true).attr("id", `${v}-comment`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", Et().fontFamily).style("font-size", p + "px").text(N.attributeComment || "");
      w.cn = M;
  ...
  if (e.length > 0) {
    ...
    o.forEach((x) => {
      ...
      let S2 = parseFloat(z.attr("x")) + parseFloat(z.attr("width"));
      if (c) {
        x.kn.attr(
          "transform",
          "translate(" + (S2 + s) + "," + P + ")"
...
var ce = function(t, r, e) {
  ...
  return n.forEach(function(p) {
    ...
    s = s === void 0 ? f : s;
    const c = "text-" + f, _ = o.append("text").classed("er entityLabel", true).attr("id", c).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "middle").style("font-family", Et().fontFamily).style("font-size", R.fontSize + "px").text(p), { width: E, height: g } = oe(
      o,
      _,
      r[p].attributes
...
var de = function(t, r, e, n, s) {
  ...
  const p = e.edge(
    ...
    return A2.y;
  }).curve(Qf), o = t.insert("path", "#" + n).classed("er relationshipLine", true).attr("d", f(p.points)).style("stroke", R.stroke).style("fill", "none");
  ...
  const _ = o.node().getTotalLength(), E = o.node().getPointAtLength(_ * 0.5), g = "rel" + ft, y = t.append("text").classed("er relationshipLabel", true).attr("id", g).attr("x", E.x).attr("y", E.y).style("text-anchor", "middle").style("dominant-baseline", "middle").style("font-family", Et().fontFamily).style("font-size", R.fontSize + "px").text(r.roleA).node().getBBox();
...
var ue = function(t, r, e, n) {
  R = Et().er, b.info("Drawing ER diagram");
  ...
  wm(o, A2, y, R.useMaxWidth), o.attr("viewBox", `${O.x - g} ${O.y - g} ${y} ${A2}`);
};
...
//# sourceMappingURL=erDiagram-6e9c0e5f-EWWDRJIP.js.map
