...
// node_modules/.pnpm/registry.npmmirror.com+mermaid@10.2.0/node_modules/mermaid/dist/createText-8ca1146d.js
function zt(n, r) {
...
function wr(n) {
  ...
  function e(m) {
    ...
    for (b2.position = {
      ...
      b2 = r.transforms[I](b2) || b2;
    return b2;
  }
  function u(m, b2, E) {
    let z = b2 - 1, I = -1, X = false, ln, rn, gn, kn;
    for (; ++z <= E; ) {
      const M = m[z];
  ...
  function l(m, b2) {
    return E;
    function E(z) {
      p.call(this, m(z), z), b2 && b2.call(this, z);
    }
  }
  function c() {
    this.stack.push({
  ...
  function p(m, b2, E) {
    return this.stack[this.stack.length - 1].children.push(m), this.stack.push(m), this.tokenStack.push([b2, E]), m.position = {
      start: on(b2.start)
    }, m;
  }
  function h(m) {
  ...
  function x(m, b2) {
    ...
    if (z)
      z[0].type !== m.type && (b2 ? b2.call(this, m, z[0]) : (z[1] || Xn).call(this, m, z[0]));
    else
      throw new Error(
  ...
  function k(m) {
    if (i("expectingFirstListItemValue")) {
      const b2 = this.stack[this.stack.length - 2];
      b2.start = Number.parseInt(this.sliceSerialize(m), 10), a("expectingFirstListItemValue");
    }
  }
  function B() {
    const m = this.resume(), b2 = this.stack[this.stack.length - 1];
    b2.lang = m;
  }
  function D() {
    const m = this.resume(), b2 = this.stack[this.stack.length - 1];
  ...
  function L(m) {
    const b2 = this.resume(), E = this.stack[this.stack.length - 1];
    E.label = b2, E.identifier = fn(
  ...
  function P(m) {
    const b2 = this.stack[this.stack.length - 1];
    if (!b2.depth) {
  ...
  function j(m) {
    const b2 = this.stack[this.stack.length - 1];
    b2.depth = this.sliceSerialize(m).charCodeAt(0) === 61 ? 1 : 2;
  }
  function N() {
  ...
  function S(m) {
    const b2 = this.stack[this.stack.length - 1];
    let E = b2.children[b2.children.length - 1];
    (!E || E.type !== "text") && (E = Ft(), E.position = {
      start: on(m.start)
    }, b2.children.push(E)), this.stack.push(E);
  }
  function w(m) {
    const b2 = this.stack.pop();
    b2.value += this.sliceSerialize(m), b2.position.end = on(m.end);
  }
  function A(m) {
    const b2 = this.stack[this.stack.length - 1];
    if (i("atHardBreak")) {
      const E = b2.children[b2.children.length - 1];
      E.position.end = on(m.end), a("atHardBreak");
      return;
    }
    !i("setextHeadingSlurpLineEnding") && r.canContainEols.includes(b2.type) && (S.call(this, m), w.call(this, m));
  }
  function U() {
    a("atHardBreak", true);
  }
  ...
  function Q() {
    ...
    if (i("inReference")) {
      const b2 = i("referenceType") || "shortcut";
      m.type += "Reference", m.referenceType = b2, delete m.url, delete m.title;
    } else
  ...
  function H(m) {
    const b2 = this.sliceSerialize(m), E = this.stack[this.stack.length - 2];
    E.label = Sr(b2), E.identifier = fn(b2).toLowerCase();
  }
  function s() {
    const m = this.stack[this.stack.length - 1], b2 = this.resume(), E = this.stack[this.stack.length - 1];
  ...
  function an(m) {
    const b2 = this.sliceSerialize(m), E = i("characterReferenceType");
    let z;
    E ? (z = ht(
      b2,
      E === "characterReferenceMarkerNumeric" ? 10 : 16
    ), a("characterReferenceType")) : z = Ln(b2);
  ...
  function pn(m) {
    w.call(this, m);
    const b2 = this.stack[this.stack.length - 1];
    b2.url = this.sliceSerialize(m);
  }
  function mn(m) {
    w.call(this, m);
    const b2 = this.stack[this.stack.length - 1];
    b2.url = "mailto:" + this.sliceSerialize(m);
  }
  function Fn() {
    return {
      type: "blockquote",
...
var Or = (n, r = "", {
  ...
  if (b.info("createText", r, t, e, u, a, i, c), a) {
    const p = zr(r), h = {
      isNode: i,
      label: Px(p).replace(
        /fa[blrs]?:fa-[\w-]+/g,
...
//# sourceMappingURL=chunk-GVBEN4W3.js.map
